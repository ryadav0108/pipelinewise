...
## Introduction
Extracts data from MSSQL databases. Supporting Log-Based Incremental, Key-Based Incremental and Full Table replications

## How-To
To integrate the [singer-io/tap-mssql](https://github.com/singer-io/tap-mssql) with PipelineWise, following files have to be modified
